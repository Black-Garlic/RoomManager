...
(function($) {
   ...
   $.widget("ui.weekCalendar", {
      ...
      _renderCalendar : function() {
         ...
         var html = "<div class=\"wc-nav\">\
                 <form id=\"list\">\
                   <select>" + roomData +
                     "</select>\
                 </form>\
                 <button class=\"check\">Okay</button>\
         ...
         if (options.buttons) {
            calendarNavHtml = $(html).append(calendarNavHtml);
      ...
      _setupEventCreationForWeekDay : function($weekDay) {
         ...
         $weekDay.mousedown(function(event) {
            ...
            if ($target.hasClass("wc-day-column-inner")) {
               ...
               $newEvent.css({lineHeight: (options.timeslotHeight - 2) + "px", fontSize: 10 + "px"});
      ...
      _renderEvent: function (calEvent, $weekDay) {
         ...
         $calEvent.css({lineHeight: (options.timeslotHeight - 2) + "px", fontSize: 10 + "px"});
